...
if (firstAnswer === 'left') {
    ...
    if (secondAnswer == 'continue') {
        window.prompt(`You come across a chamber that reaches upward to a shining light above. 
    ...
    else (`After ascending the staircase, you discover a shiny blue stone, which you take home and cherish forever.`);
}
